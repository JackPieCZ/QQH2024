...
def calculate_win_probs_frantisek(summary, opp, games_inc, players_inc, database):
...
def calculate_win_probs_frantisek2(summary, opp, games_inc, players_inc, database):
    """Calculates win probabilities for home and away team.
